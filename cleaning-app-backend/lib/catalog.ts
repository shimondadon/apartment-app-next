/**
 * מקור יחיד לדירות ולקטגוריות משימות — שינוי כאן משפיע על כל ה-API והסיכומים.
 */
import type { Apartment, TaskCategory } from '@/lib/types';
